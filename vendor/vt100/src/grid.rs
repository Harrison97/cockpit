...
impl Grid {
    ...
    pub fn visible_rows(&self) -> impl Iterator<Item = &crate::row::Row> {
        ...
        // This avoids overflow when scrollback_offset > scrollback_len or > rows_len
